...
export default function CleanerPreviousWeekReportLayout({
  children,
}: {
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      `}>
        ...
        <nav className="flex flex-col gap-2">
          ...
          <Link href="/cleaner/previous-week-report" legacyBehavior>
            <a 
              className={`px-3 py-2 rounded-md font-medium text-sm transition-colors ${pathname === '/cleaner/previous-week-report' ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100'}`}
              onClick={closeSidebar}
            >
